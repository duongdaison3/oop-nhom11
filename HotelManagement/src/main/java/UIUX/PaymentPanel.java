...
public class PaymentPanel extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btn_checkOut.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/java/images/Screenshot 2023-04-22 160945.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/java/images/generate.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/java/images/meme.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(278, 278, 278)
                        .addComponent(btn_checkOut, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(248, 248, 248)
                        .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(206, 206, 206)
                        .addComponent(combo_booking, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(53, 53, 53)
                .addComponent(combo_booking, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (bookingId != -1) {
            ...
            JOptionPane.showMessageDialog(null, "No booking selected, try to select one from suggestion box");
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            MessageFormat header = new MessageFormat("Technologies");
            MessageFormat footer = new MessageFormat("Hotel Management");
        ...
        editor.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent evt) {
                ...
                if (evt.getKeyChar() == KeyEvent.VK_ENTER) {
                    ...
                    if (!details.contains(",")) {
                        JOptionPane.showMessageDialog(null, "No booking results found, try adding a new booking");
                    } else {
